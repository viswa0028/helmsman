...
export const TOOLS = [
    {
        ...
        function: {
            ...
            description: 'Snapshot of the live cluster: nodes, deployments with replicas, resource requests, and estimated hourly cost (INR).',
            parameters: {
                type: 'object',
                properties: {
    ...
    },
    {
        ...
        function: {
            ...
            description: 'Read the LIVE PodDisruptionBudget status and evaluate whether scaling to a target replica count is safe.',
            parameters: {
                type: 'object',
                properties: {
    ...
    },
    {
        ...
        function: {
            ...
            description: 'Scale a deployment. SAFETY-ENFORCED: server re-reads the live PDB and policy floor and REJECTS any unsafe scale-down.',
            parameters: {
                type: 'object',
                properties: {
                    name: { type: 'string', description: 'Deployment name' },
